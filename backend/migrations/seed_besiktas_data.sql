...
VALUES 
    ('11111111-1111-1111-1111-111111111111', 'Beşiktaş Merkez', 41.0425, 29.0085, 500, 'completed', 10, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
...
VALUES 
    ...
    ('22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'Beşiktaş Merkez', 'Çırağan Caddesi No:45', 41.0430, 29.0090, 90, 'https://maps.googleapis.com/maps/api/streetview?size=640x480&location=41.0430,29.0090&heading=90', 30.2, 'EMERGENCY', 4, true, 2026, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    ('22222222-2222-2222-2222-222222222224', '11111111-1111-1111-1111-111111111111', 'Beşiktaş Merkez', 'Nispetiye Caddesi No:156', 41.0435, 29.0095, 270, 'https://maps.googleapis.com/maps/api/streetview?size=640x480&location=41.0435,29.0095&heading=270', 50.3, 'RISKY', 2, false, 2026, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    ('22222222-2222-2222-2222-222222222226', '11111111-1111-1111-1111-111111111111', 'Beşiktaş Merkez', 'Abbasağa Parkı Sokak No:34', 41.0440, 29.0100, 135, 'https://maps.googleapis.com/maps/api/streetview?size=640x480&location=41.0440,29.0100&heading=135', 72.4, 'ATTENTION', 1, false, 2026, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    ('22222222-2222-2222-2222-222222222229', '11111111-1111-1111-1111-111111111111', 'Beşiktaş Merkez', 'Şair Nedim Caddesi No:101', 41.0405, 29.0065, 0, 'https://maps.googleapis.com/maps/api/streetview?size=640x480&location=41.0405,29.0065&heading=0', 92.3, 'HEALTHY', 0, false, 2026, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222230', '11111111-1111-1111-1111-111111111111', 'Beşiktaş Merkez', 'Muradiye Deresi Caddesi No:56', 41.0450, 29.0110, 90, 'https://maps.googleapis.com/maps/api/streetview?size=640x480&location=41.0450,29.0110&heading=90', 95.1, 'HEALTHY', 0, false, 2026, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;

-- Insert defects for EMERGENCY buildings
...
VALUES 
    ...
    ('22222222-2222-2222-2222-222222222222', 'structural_crack', 5, 0.89, false, 120, 180, 280, 380, 'Kritik yapısal hasar', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222222', 'frame_deformation', 4, 0.91, false, 200, 150, 450, 400, 'Çerçeve deformasyonu', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222222', 'damaged_fire_escape', 3, 0.86, false, 500, 100, 620, 300, 'Yangın merdiveni hasarlı', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222222', 'spalling', 4, 0.93, false, 80, 250, 220, 450, 'Ciddi beton dökülmesi', CURRENT_TIMESTAMP),
    ...
    -- Building 4 - RISKY
    ('22222222-2222-2222-2222-222222222224', 'structural_crack', 3, 0.79, false, 200, 180, 380, 350, 'Çatlak tespit edildi', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222224', 'deformed_balcony', 2, 0.82, false, 400, 200, 600, 400, 'Balkon hafif deformasyonlu', CURRENT_TIMESTAMP),
    ...
    -- Building 6 - ATTENTION
    ('22222222-2222-2222-2222-222222222226', 'corrosion_stain', 1, 0.72, false, 300, 280, 450, 420, 'Minimal korozyon', CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
...
VALUES 
    ...
    ('22222222-2222-2222-2222-222222222222', 41.0430, 29.0090, 'Dış cephede büyük beton parçaları düşmüş', '', 'reviewed', CURRENT_TIMESTAMP),
